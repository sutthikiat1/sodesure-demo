...
function RecommendationScreen() {
  ...
  return (
    <div className="w-full min-h-screen mt-16">
      <div className="w-full max-w-md md:max-w-2xl lg:max-w-4xl mx-auto px-0 md:px-6 py-6 md:py-8 grid gap-3">
        {/* Header */}
        ...
        {/* Meat Type Card */}
        <div className="bg-white rounded-3xl shadow-md p-4 md:p-6 lg:p-8 mb-2 border border-gray-100">
          {/* Type Header */}
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <span className="text-2xl md:text-3xl bg-orange-100 p-2 rounded-[100px] w-12 h-12 md:w-14 md:h-14 flex items-center justify-center">
                {currentRec.icon}
              </span>
          ...
          {/* Optimal Temperature */}
          <div className="mb-4.5 h-20 md:h-24 px-4 md:px-5 rounded-2xl bg-gray-100 items-center flex">
            <div className="bg-blue-100 rounded-lg p-3">
              <Thermometer className="w-5 h-5 md:w-6 md:h-6 text-blue-600" />
            </div>
            <div className="gap-3 my-auto ml-4 md:ml-5">
              <span className="text-sm md:text-base font-semibold text-gray-800">
                อุณหภูมิที่เหมาะสม
              </span>
              <p className="text-sm md:text-base text-gray-600">
                {currentRec.optimalTemp}
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 mb-6">
            {/* Fridge */}
            <div className="flex-1 h-20 md:h-24 px-4 md:px-5 rounded-2xl bg-gray-100 items-center flex">
              <div className="bg-blue-100 rounded-lg p-3">
                <Snowflake className="w-5 h-5 md:w-6 md:h-6 text-blue-500" />
              </div>
              <div className="gap-1 my-auto ml-4 md:ml-5 flex flex-col">
        ...
        {/* Additional Tips */}
        <div className="bg-blue-50 rounded-2xl p-4 md:p-5 border border-blue-200 mb-6">
